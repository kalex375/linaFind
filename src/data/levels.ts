...
export const builtInLevels: Level[] = [
  ...
  },
  {
    ...
    source: 'ai',
    items: [
      { id: 'cup', role: 'search-target', label: { pt: 'copo', en: 'cup', uk: 'чашка' }, showLabelOnImage: true, targetArea: { x: 26, y: 61, width: 11, height: 15 }, thumbnailArea: { x: 26, y: 60, width: 11, height: 16 } },
      { id: 'spoon', role: 'search-target', label: { pt: 'colher', en: 'spoon', uk: 'ложка' }, showLabelOnImage: true, targetArea: { x: 38, y: 70, width: 15, height: 9 }, thumbnailArea: { x: 38, y: 70, width: 15, height: 9 } },
      { id: 'apple', role: 'search-target', label: { pt: 'maçã', en: 'apple', uk: 'яблуко' }, showLabelOnImage: true, targetArea: { x: 40, y: 53, width: 9, height: 14 }, thumbnailArea: { x: 40, y: 52, width: 10, height: 15 } },
      { id: 'pot', role: 'search-target', label: { pt: 'panela', en: 'pot', uk: 'каструля' }, showLabelOnImage: true, targetArea: { x: 59, y: 50, width: 18, height: 19 }, thumbnailArea: { x: 59, y: 50, width: 19, height: 20 } },
      { id: 'clock', role: 'search-target', label: { pt: 'relógio', en: 'clock', uk: 'годинник' }, showLabelOnImage: true, targetArea: { x: 80, y: 5, width: 12, height: 18 }, thumbnailArea: { x: 80, y: 4, width: 12, height: 19 } },
